...
function donovan_widgets_init() {
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Search Sidebar', 'donovan' ),
		'id'            => 'sidebar-2',
		'description'   => esc_html_x( 'Sidebar will appear on posts and pages, except with the full width template.', 'widget area description', 'donovan' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Footer Sidebar', 'donovan' ),
		'id'            => 'sidebar-3',
		'description'   => esc_html_x( 'Sidebar will appear on footer page.', 'widget area description', 'donovan' ),
		'before_widget' => '',
		'after_widget'  => '',
		'before_title'  => '',
		'after_title'   => '',
...
function donovan_custom_fonts() {
	...
	wp_enqueue_style( 'donovan-stylesheet-css', get_template_directory_uri() . '/custom.css', array(), '20180913' );
	
	wp_enqueue_style( 'donovan-stylesheet-css-1', get_template_directory_uri() . '/assets/css/simple-line-icons.css', array(), '20180914' );
	wp_enqueue_style( 'donovan-stylesheet-css-2', get_template_directory_uri() . '/assets/css/themify-icons.css', array(), '20180915' );
	wp_enqueue_style( 'donovan-stylesheet-css-3', get_template_directory_uri() . '/assets/css/font-awesome.min.css', array(), '20180916' );
